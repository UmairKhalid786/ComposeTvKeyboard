...
sealed class SpecialCharacters(
    ...
    object Dot : SpecialCharacters(".", ".")
    object Underscore : SpecialCharacters("_", "_")
    object Dash : SpecialCharacters("-", "-")
    object Exclamation : SpecialCharacters("!", "!")
    object Hash : SpecialCharacters("#", "#")
    object Ampersat : SpecialCharacters("@", "@")
    object Comma : SpecialCharacters(",", ",")
}
